        ...
        <div class="home-slideshow">
            <div class="slide">
                <div class="blur-up lazyload bg-size">
                    <img class="blur-up lazyload bg-img" data-src="{{ asset('assets/images/slideshow-banners/home14-bags-bnr1.jpg') }}" src="{{ asset('assets/images/slideshow-banners/home14-bags-bnr1.jpg') }}" alt="Shop Our New Collection" title="Shop Our New Collection" />
            ...
            <div class="slide">
                <div class="blur-up lazyload bg-size">
                    <img class="blur-up lazyload bg-img" data-src="{{ asset('assets/images/slideshow-banners/home5-banner2.jpg') }}" src="{{ asset('assets/images/slideshow-banners/home5-banner2.jpg') }}" alt="Summer Bikini Collection" title="Summer Bikini Collection" />
                    <div class="slideshow__text-wrap slideshow__overlay classic bottom">
                        <div class="slideshow__text-content bottom">
                            <div class="wrap-caption center">
            ...
            <div class="collection-grid">
                <div class="collection-grid-item">
                    <a href="collection-page.html" class="collection-grid-item__link">
                        <img data-src="{{ asset('assets/images/collection/modern-fi-1.jpg') }}" src="{{ asset('assets/images/collection/modern-fi-1.jpg') }}" alt="Fashion" class="blur-up lazyload"/>
                ...
                <div class="collection-grid-item">
                    <a href="collection-page.html" class="collection-grid-item__link">
                        <img class="blur-up lazyload" data-src="{{ asset('assets/images/collection/cosmetic.jpg') }}" src="{{ asset('assets/images/collection/cosmetic.jpg') }}" alt="Cosmetic"/>
                        <div class="collection-grid-item__title-wrapper">
                ...
                <div class="collection-grid-item blur-up lazyloaded">
                    <a href="collection-page.html" class="collection-grid-item__link">
                        <img data-src="{{ asset('assets/images/collection/bag.jpg') }}" src="{{ asset('assets/images/collection/bag.jpg') }}" alt="Bag" class="blur-up lazyload"/>
                        <div class="collection-grid-item__title-wrapper">
                ...
                <div class="collection-grid-item">
                    <a href="collection-page.html" class="collection-grid-item__link">
                        <img data-src="{{ asset('assets/images/collection/accessories.jpg') }}" src="{{ asset('assets/images/collection/accessories.jpg') }}" alt="Accessories" class="blur-up lazyload"/>
                        <div class="collection-grid-item__title-wrapper">
                ...
                <div class="collection-grid-item">
                    <a href="collection-page.html" class="collection-grid-item__link">
                        <img data-src="{{ asset('assets/images/collection/shoes.jpg') }}" src="{{ asset('assets/images/collection/shoes.jpg') }}" alt="Shoes" class="blur-up lazyload"/>
                        <div class="collection-grid-item__title-wrapper">
                ...
                <div class="collection-grid-item">
                    <a href="collection-page.html" class="collection-grid-item__link">
                        <img data-src="{{ asset('assets/images/collection/jewellry.jpg') }}" src="{{ asset('assets/images/collection/jewellry.jpg') }}" alt="Jewellry" class="blur-up lazyload"/>
                        <div class="collection-grid-item__title-wrapper">
