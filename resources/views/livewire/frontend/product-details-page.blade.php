                            ...
                            <div class="swatch clearfix swatch-0 option1" data-option-index="0">
                                <div class="product-form__item">
                                    ...
                                    <div data-value="aqua" class="swatch-element color aqua available">
                                        ...
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-aqua" style="background-image:url({{ asset('assets/images/product-detail-page/variant1-3.jpg') }});" title="aqua"></label>
                                    </div>
                                    <div data-value="Orange" class="swatch-element color orange available">
                                        <input class="swatchInput" id="swatch-0-orange" type="radio" name="option-0" value="Orange">
                                        <label class="swatchLbl color medium rectangle" for="swatch-0-orange" style="background-image:url({{ asset('assets/images/product-detail-page/variant1-1.jpg') }});" title="Orange"></label>
                                    </div>
                                </div>
                            </div>
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="{{ route('products.details', $key->slug) }}">
                                ...
                                <!-- End hover image -->
                                <!-- product label -->
                                <div class="product-labels rectangular"><span class="lbl on-sale">-16%</span> <span class="lbl pr-label1">new</span> <span class="lbl pr-label2">Hot</span> <span class="lbl on-sale">Sale</span></div>
                                <!-- End product label -->
                            </a>
                            <!-- end product image -->
                    ...
                    <div class="col-12 item">
                        ...
                        <div class="product-image">
                            ...
                            <a href="#">
                                ...
                                <!-- End image -->
                                <!-- Hover image -->
                                <img class="hover blur-up lazyload" data-src="{{ asset('assets/images/product-images/product-image6-1.jpg') }}" src="{{ asset('assets/images/product-images/product-image6-1.jpg') }}" alt="image" title="product">
                                <!-- End hover image -->
                                <!-- product label -->
