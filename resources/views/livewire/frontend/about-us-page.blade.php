    ...
    <div class="container">
        <div class="row">
            <div class="col-12 col-sm-12 col-md-12 col-lg-12 main-col">
                <div class="text-center mb-4">
                    <h2 class="h2">Bootstrap 4 Html Template</h2>
        ...
        <div class="row">
            <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4">
                <img class="blur-up lazyload" data-src="{{ asset('assets/images/about1.jpg') }}" src="{{ asset('assets/images/about1.jpg') }}" alt="About Us" />
            </div>
            <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4">
                <img class="blur-up lazyload" data-src="{{ asset('assets/images/about2.jpg') }}" src="{{ asset('assets/images/about2.jpg') }}" alt="About Us" />
            </div>
            <div class="col-12 col-sm-4 col-md-4 col-lg-4 mb-4">
                <img class="blur-up lazyload" data-src="{{ asset('assets/images/about3.jpg') }}" src="{{ asset('assets/images/about3.jpg') }}" alt="About Us" />
            </div>
        </div>
        <div class="row">
            <div class="col-12">
