...
@elseif (request()->routeIs('products.index') || request()->routeIs('products.list') || request()->routeIs('products.by_category'))
    template-collection
            ...
            <div class="container-fluid">
                <div class="row align-items-center">
                    ...
                    <div class="logo col-md-2 col-lg-2 d-none d-lg-block">
                        <a href="{{ route('home') }}">
                        	<img src="{{ asset('assets/images/logo.svg') }}" alt="Shop Logo" title="Shop Logo" />
                        </a>
                    </div>
                    <!--End Desktop Logo-->
                                        ...
                                        <ul class="dropdown">
                                            ...
                                            <li>
                                                <form method="POST" action="{{ route('logout') }}">
                                                    @csrf
                                                    <a href="{{ route('logout') }}" class="site-nav" onclick="event.preventDefault();
