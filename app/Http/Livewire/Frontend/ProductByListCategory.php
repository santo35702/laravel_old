...
class ProductByListCategory extends Component
{
    public $sorting;
    public $pagesize;
    public $slug;
    ...
    public function render()
    {
        ...
        return view('livewire.frontend.product-by-list-category', ['products' => $products, 'popular_products' => $popular_products, 'category' => $category, 'sale_date' => $sale_date])->layout('layouts.base');
    }
}
